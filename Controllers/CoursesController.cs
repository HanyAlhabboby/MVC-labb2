...
namespace StockholmSchool5.Controllers
{
    public class CoursesController : Controller
    {
        ...
        {
            var updateCourse = _context.Courses.FirstOrDefault(c => c.CourseId == 8);
        ...
        public async Task<IActionResult> UpdateCourse(string courseName)
        {
            var courseToUpdate = await _context.Courses.FirstOrDefaultAsync(e => e.CourseId == 8);
